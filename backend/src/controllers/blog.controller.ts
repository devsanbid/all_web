...
export class BlogController {
    ...
    async updateBlog(req: Request, res: Response) {
        try {
            ...
            const updatedBlog = await blogService.updateBlog(id, authorId, parseResult.data);
            return ApiResponseHelper.success(res, updatedBlog, 200, "Blog updated successfully");
        } catch (e: Error | any) {
            return ApiResponseHelper.error(
                res,
    ...
    async deleteBlog(req: Request, res: Response) {
        try {
            ...
            return ApiResponseHelper.success(res, deletedBlog, 200, "Blog deleted successfully");
        } catch (e: Error | any) {
            return ApiResponseHelper.error(
                res,
